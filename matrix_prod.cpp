...
int main() {
  ...
  do {
    ...
    if (m2->rownum <= 0) {
      ...
      cout << "Error. Matrix_2's row number must be equal to Matrix_1's column "
              "number."
           << endl;
    }
  ...
  cout << endl
       << "Please enter the elements of Matrix_1, from up to down, left to "
          "right:"
       << endl;
  ...
  cout << "Please enter the elements of Matrix_2, from up to down, left to "
          "right:"
       << endl;
